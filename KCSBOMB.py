#########################################
# KCSBomber
# A Bangladeshi KCS Bomber Tool
# Author: CEO OF JISHAN Inc.
# GitHub: https://github.com/J1SH4N
# Version: 4.1.0
#########################################
...
def logo():
    ...
    print("\033[94m│     \033[92m    db   dD       .o88b.      .d8888.\033[94m   │".center(columns+15))
    print("\033[94m│     \033[92m 88 ,8P'      d8P  Y8      88'  YP\033[94m   │".center(columns+15))
    print("\033[94m│     \033[92m 88,8P        8P           `8bo.  \033[94m   │".center(columns+15))
    print("\033[94m│     \033[92m 88`8b        8b             `Y8b.  \033[94m   │".center(columns+15))
    print("\033[94m│     \033[92m 88 `88.      Y8b  d8      db   8D \033[94m          │".center(columns+9))
    print("\033[94m│     \033[92m YP   YD       `Y88P'      `8888Y' \033[94m          │".center(columns+9))
